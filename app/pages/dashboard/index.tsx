...
export default function Dashboard() {
    ...
    let [serverDetails, setServerDetails] = useState<Record<string, {
        name: string;
        ip: string;
        port: number;
        color: string
    ...
    return (
        <>
            ...
            <Modal isOpen={!!userPasswordTarget} onOpenChange={() => setUserPasswordTarget(null)}
